...
#
# Copyright (C) 2016-2019 Modified by shigeno <@phcorner>
#
...
# 
# Intro:  https://www.phcorner.net/members/446256/
...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo "Please visit: https://www.phcorner.net/members/446256/ and contact."
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p "(Default password: shigeno):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="shigeno"
    echo
